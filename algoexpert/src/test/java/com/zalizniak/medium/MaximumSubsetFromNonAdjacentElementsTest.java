...
import static com.zalizniak.medium.MaximumSubsetFromNonAdjacentElements.getSumDynamicProgramming;
import static com.zalizniak.medium.MaximumSubsetFromNonAdjacentElements.getSumMostEfficientWay;
...
public class MaximumSubsetFromNonAdjacentElementsTest {
    ...
    public void shouldFindSum() {
        ...
        int expected = 13;
        Assert.assertEquals(expected, getSumDynamicProgramming(input));
    }
